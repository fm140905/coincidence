 ...
 * @LastEditTime: 2021-04-06 12:38:57
 */
...
public:
    void SetUp() override{
        f = "unitest/loadChannelTest.json";
...
TEST_F(ChannelTest, loadEvents)
{
    ...
    EXPECT_EQ(channel1->events.size(), 10000);
...
{   
    ...
    goodPulseCanvasCH0->SaveAs("unitest/output/Good pulses - channel 0.png");
    ...
    goodPulseCanvasCH1->SaveAs("unitest/output/Good pulses - channel 1.png");
    ...
    badPulseCanvasCH0->SaveAs("unitest/output/rejected pulses - channel 0.png");
    ...
    badPulseCanvasCH1->SaveAs("unitest/output/rejected pulses - channel 1.png");
}
...
TEST_F(ChannelTest, plotPHDTest)
{
    ...
    PHDCanvasCH0->SaveAs("unitest/output/PHD - channel 0.png");
    ...
    PHDCanvasCH1->SaveAs("unitest/output/PHD - channel 1.png");
...
TEST_F(ChannelTest, plotPIDTest)
{
    ...
    PIDCanvasCH0->SaveAs("unitest/output/PID - channel 0.png");
    ...
    PIDCanvasCH1->SaveAs("unitest/output/PID - channel 1.png");
}
...
TEST_F(ChannelTest, plotPSDTest)
{
    ...
    PSDCanvasCH0->SaveAs("unitest/output/PSD - channel 0.png");
    ...
    PSDCanvasCH1->SaveAs("unitest/output/PSD - channel 1.png");
}
...
//     channel0->PID.DrawClone();
//     PIDCanvasCH0->DrawClone();
//     PIDCanvasCH0->SaveAs("unitest/output/Cut PID - channel 0.png");
...
//     channel1->PID.DrawClone();
//     PIDCanvasCH1->DrawClone();
//     PIDCanvasCH1->SaveAs("unitest/output/Cut PID - channel 1.png");
...
//     goodPulseCanvasCH0->DrawClone();
//     goodPulseCanvasCH0->SaveAs("unitest/output/Interpolated pulses - channel 0.png");
...
//     goodPulseCanvasCH1->DrawClone();
//     goodPulseCanvasCH1->SaveAs("unitest/output/Interpolated pulses - channel 1.png");
...
//     channel0->interpPulseGraph.DrawClone("A PLC PMC");
//     goodPulseCanvasCH0->DrawClone();
//     goodPulseCanvasCH0->SaveAs("unitest/output/Bipolar pulses - channel 0.png");
...
//     channel1->interpPulseGraph.DrawClone("A PLC PMC");
//     goodPulseCanvasCH1->DrawClone();
//     goodPulseCanvasCH1->SaveAs("unitest/output/Bipolar pulses - channel 1.png");
